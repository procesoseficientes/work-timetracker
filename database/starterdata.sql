...
INSERT INTO public.access (role_id, route, "create", read, update, delete) VALUES (1, '/', true, true, true, true);
INSERT INTO public.access (role_id, route, "create", read, update, delete) VALUES (1, '/team', true, true, true, true);
INSERT INTO public.access (role_id, route, "create", read, update, delete) VALUES (1, '/users', true, true, true, true);
INSERT INTO public.access (role_id, route, "create", read, update, delete) VALUES (1, '/projects', true, true, true, true);
INSERT INTO public.access (role_id, route, "create", read, update, delete) VALUES (1, '/owners', true, true, true, true);
INSERT INTO public.access (role_id, route, "create", read, update, delete) VALUES (1, '/roles', true, true, true, true);
INSERT INTO public.access (role_id, route, "create", read, update, delete) VALUES (1, '/types', true, true, true, true);
INSERT INTO public.access (role_id, route, "create", read, update, delete) VALUES (1, '/stats', true, true, true, true);
INSERT INTO public.access (role_id, route, "create", read, update, delete) VALUES (1, '/detail', true, true, true, true);
