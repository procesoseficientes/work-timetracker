...
!function(a, b) {
  ...
  var x = function(a) {
      ...
      m = ga.setDocument = function(a) {
          ...
          r = [],
          q = [],
          (c.qsa = Y.test(n.querySelectorAll)) && (ja((a) => {
      ...
      d = ga.selectors = {
          ...
          filter: {
              ...
              PSEUDO: function(a, b) {
                  ...
                  d.setFilters.hasOwnProperty(a.toLowerCase()) ? ia((a, c) => {
  ...
  var C = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i
    , D = /^.[^:#\[\.,]*$/
  function E(a, b, c) {
      return r.isFunction(b) ? r.grep(a, (a, d) => {
  ...
  r.filter = function(a, b, c) {
      var d = b[0]
      return c && (a = ":not(" + a + ")"),
      1 === b.length && 1 === d.nodeType ? r.find.matchesSelector(d, a) ? [d] : [] : r.find.matches(a, r.grep(b, (a) => {
          return 1 === a.nodeType
      }))
  }
  ,
  ...
  r.each(["height", "width"], (a, b) => {
      r.cssHooks[b] = {
          get: function(a, c, d) {
              if (c)
                  return !Qa.test(r.css(a, "display")) || a.getClientRects().length && a.getBoundingClientRect().width ? $a(a, b, d) : ea(a, Sa, () => {
                      return $a(a, b, d)
                  })
          },
          set: function(a, c, d) {
          ...
          var b, c, d, e = this[0]
          {
              if (arguments.length)
                  ...
                  this.each(function(c) {
                      ...
                      null == e ? e = "" : "number" == typeof e ? e += "" : Array.isArray(e) && (e = r.map(e, (a) => {
                          return null == a ? "" : a + ""
                      })),
  ...
  r.fn.extend({
      ...
      serializeArray: function() {
          return this.map(function() {
              ...
              var c = r(this).val()
              return null == c ? null : Array.isArray(c) ? r.map(c, (a) => {
                  return {
                      name: b.name,
                      value: a.replace(ib, "\r\n")
                  }
